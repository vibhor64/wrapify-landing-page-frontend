    ...
    return (
      <div className='super-div py-20'>
        ...
        <div className='pager'>
          ...
          <ul className='list-decimal limiter pl-12 border-l-2 border-white ml-20' style={{ maxWidth: '20rem', maxHeight: '291px', position: 'relative', height:'291px'}}>
              <div className='imagePlace' style={{ backgroundImage: `url(${emotionJPG})`, height:'4.2rem'}}> </div>
              <li>&nbsp;Emotion Engine</li>
              <p className='artist'>&nbsp; After Oceans</p>
              <div className='imagePlace' style={{ backgroundImage: `url(${chaseJPG})`, top: '4.2rem'}}> </div>
              <li> &nbsp;I Just Need (With Lyrah)</li>
              <p className='artist' style={{textOverflow: 'ellipsis'}}>&nbsp; Daniel Allan, Lyrah Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim harum, aperiam corporis beatae libero vero inventore expedita totam doloremque odit accusamus tempora modi necessitatibus molestias laboriosam ad. Dolorum, tempore nesciunt.</p>
